...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "highcoin-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "highcoin-test" in runHighcoin.
	reexec.Register("highcoin-test", func() {
...
// spawns highcoin with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runHighcoin(t *testing.T, args ...string) *testhighcoin {
	tt := &testhighcoin{}
	...
	// Boot "highcoin". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("highcoin-test", args...)
