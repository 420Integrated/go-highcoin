...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Highcoin presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    highcoin wallet import /path/to/my/presale.wallet

will prompt for your password and imports your highcoin presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Highcoin presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	highcoin wallet [options] /path/to/my/presale.wallet
...
between highcoin nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    highcoin account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    highcoin account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    highcoin account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    highcoin account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another highcoin instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := highcoinConfig{Node: defaultNodeConfig()}
	// Load config file.
