...
// Start highcoin with
//
// build/bin/highcoin --nodiscover --maxpeers 0 --signer http://localhost:8550 console --preload=cmd/clef/tests/testsigner.js
//
...
function testSignText(){
    if( accts && accts.length > 0){
        var a = accts[0]
        var r = high.sign(a, "0x68656c6c6f20776f726c64"); //hello world
