...
// Address represents the 20 byte address of an Highcoin account.
...
// IsHexAddress verifies if a string can represent a valid hex-encoded
// Highcoin address or not.
