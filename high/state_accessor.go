...
func (high *Highcoin) stateAtBlock(block *types.Block, reexec uint64) (statedb *state.StateDB, release func(), err error) {
...
func (high *Highcoin) statesInRange(fromBlock, toBlock *types.Block, reexec uint64) (states []*state.StateDB, release func(), err error) {
...
func (high *Highcoin) stateAtTransaction(block *types.Block, txIndex int, reexec uint64) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
