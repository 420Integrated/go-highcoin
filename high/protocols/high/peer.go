...
// Peer is a collection of relevant information we have about a `high` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `high` protocol version.
...
// ReplyPooledTransactionsRLP is the high/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the high/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the high/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the high/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the high/66 response to GetReceipts.
