...
// TestHigh66EmptyMessages tests encoding of empty high66 messages
func TestHigh66EmptyMessages(t *testing.T) {
...
// TestHigh66Messages tests the encoding of all redefined high66 messages
func TestHigh66Messages(t *testing.T) {
