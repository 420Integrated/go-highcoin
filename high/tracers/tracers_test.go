...
import (
	...
	"github.com/420integrated/go-highcoin/tests"
)

// To generate a new callTracer test, copy paste the makeTest method below into
// a Highcoin console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = high.getBlock(high.getTransaction(tx).blockHash);
  var genesis = high.getBlock(block.parentHash);
  ...
  genesis.smokeLimit  = genesis.smokeLimit.toString();
  ...
  genesis.config = admin.nodeInfo.protocols.high.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  high.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
...
type callTrace struct {
	...
	Smoke     *hexutil.Uint64 `json:"smoke,omitempty"`
	SmokeUsed *hexutil.Uint64 `json:"smokeUsed,omitempty"`
...
func TestPrestateTracerCreate2(t *testing.T) {
	...
	/**
	    ...
	    smoke (assuming no mem expansion): 32006
	...
	*/
	...
	st := core.NewStateTransition(evm, msg, new(core.SmokePool).AddSmoke(tx.Smoke()))
