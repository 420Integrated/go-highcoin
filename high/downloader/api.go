...
// Syncing provides information when this nodes starts synchronising with the Highcoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  highcoin.SyncProgress `json:"status"`
}
