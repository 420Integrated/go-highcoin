...
// information related to the Highcoin protocol such als blocks, transactions and logs.
...
// `high_getFilterChanges` polling method that is also used for log filters.
//
// https://420integrated.com/wiki/json-rpc/API#high_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with high_getFilterChanges.
//
// https://420integrated.com/wiki/json-rpc/API#high_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(highcoin.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as highcoin.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria highcoin.FilterQuery
...
//
// https://420integrated.com/wiki/json-rpc/API#high_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(highcoin.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://420integrated.com/wiki/json-rpc/API#high_getlogs
...
//
// https://420integrated.com/wiki/json-rpc/API#high_uninstallfilter
...
//
// https://420integrated.com/wiki/json-rpc/API#high_getfilterlogs
...
//
// https://420integrated.com/wiki/json-rpc/API#high_getfilterchanges
