...
# 1. install highcoin for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for highcoin
# 5. create highcoin, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable HIGHCOIN_SOCKET
...
!define GROUPNAME "Highcoin"
!define APPNAME "Highcoin"
!define DESCRIPTION "Official Go implementation of the Highcoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since highcoin is installed global
