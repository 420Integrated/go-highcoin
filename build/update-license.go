...
Please review the resulting diff to check if the correct
...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/420integrated/go-highcoin/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-highcoin authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-highcoin Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-highcoin library"
	}
	return "the go-highcoin library"
}
