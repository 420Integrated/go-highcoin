...
// isInitDone returns if the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says if the caller wants liveness-checked results. If
