...
creating a collection of devp2p nodes, connecting them togither to form a
...
* `Expect` - an expectation function which returns if or not a
...
As a concrete example, consider a simulated network of Highcoin nodes. An
