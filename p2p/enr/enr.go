...
// Package enr implements Highcoin Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks if the record is signed using the given identity scheme.
