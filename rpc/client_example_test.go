...
//
// high_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// high_subscribe("newHeads")
...
func ExampleClientSubscription() {
	// Connect the client.
	client, _ := rpc.Dial("ws://127.0.0.1:42000")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.HighSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "high_getBlockByNumber", "latest", false)
	if err != nil {
