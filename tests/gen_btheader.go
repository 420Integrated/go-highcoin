...
func (b btHeader) MarshalJSON() ([]byte, error) {
	...
	enc.SmokeLimit = math.HexOrDecimal64(b.SmokeLimit)
	enc.SmokeUsed = math.HexOrDecimal64(b.SmokeUsed)
...
func (b *btHeader) UnmarshalJSON(input []byte) error {
	...
	if dec.SmokeLimit != nil {
		b.SmokeLimit = uint64(*dec.SmokeLimit)
	}
	if dec.SmokeUsed != nil {
		b.SmokeUsed = uint64(*dec.SmokeUsed)
	}
