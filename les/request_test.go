...
type accessTestFn func(db highdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db highdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db highdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db highdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db highdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
