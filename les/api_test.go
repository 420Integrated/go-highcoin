...
import (
	...
	"github.com/420integrated/go-highcoin/p2p/simulations"
	"github.com/420integrated/go-highcoin/p2p/simulations/adapters"
...
func getHead(ctx context.Context, t *testing.T, client *rpc.Client) (uint64, common.Hash) {
	...
	if err := client.CallContext(ctx, &res, "high_getBlockByNumber", "latest", false); err != nil {
...
func testRequest(ctx context.Context, t *testing.T, client *rpc.Client) bool {
	...
	defer cancel()
	err := client.CallContext(c, &res, "high_getBalance", addr, "latest")
	if err != nil {
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	_, err = NewLesServer(stack, highcoin, &config)
	if err != nil {
		return nil, err
	}
	return highcoin, nil
