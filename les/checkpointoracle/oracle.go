...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag if the contract backend is set or not
...
// IsRunning returns an indicator if the oracle is running.
...
// checks if there are enough approvals to finalize the checkpoint.
