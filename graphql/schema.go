...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Highcoin address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Highcoin account at a particular block.
    type Account {
    ...
    # Transaction is an Highcoin transaction.
    type Transaction {
        ...
        # running out of smoke). If the transaction has not yet been mined, this
        # field will be null.
        status: Long
        # SmokeUsed is the amount of smoke that was used processing this transaction.
        # If the transaction has not yet been mined, this field will be null.
        smokeUsed: Long
        # CumulativeSmokeUsed is the total smoke used in the block up to and including
        # this transaction. If the transaction has not yet been mined, this field
        # will be null.
        cumulativeSmokeUsed: Long
    ...
    type Block {
        ...
        extraData: Bytes!
        # SmokeLimit is the maximum amount of smoke that was available to transactions in this block.
        smokeLimit: Long!
        # SmokeUsed is the amount of smoke that was used executing transactions in this block.
        smokeUsed: Long!
        ...
        # Account fetches an Highcoin account at the current block's state.
        account(address: Address!): Account!
        # Call executes a local call operation at the current block's state.
        call(data: CallData!): CallResult
        # EstimateSmoke estimates the amount of smoke that will be required for
        # successful execution of a transaction at the current block's state.
        estimateSmoke(data: CallData!): Long!
    }
    ...
    type CallResult {
        ...
        data: Bytes!
        # SmokeUsed is the amount of smoke used by the call, after any refunds.
        smokeUsed: Long!
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Highcoin account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Highcoin block by number or by hash. If neither is
