...
// the `coin_type` 60' (or 0x8000003C) to Highcoin.
//
// The root path for Highcoin is m/44'/60'/0'/0 according to the specification
// from https://github.com/420integrated/EIPs/issues/84, albeit it's not set in stone
// yet if accounts should increment the last component or the children of
