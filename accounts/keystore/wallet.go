...
// Status implements accounts.Wallet, returning if the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain highcoin.ChainStateReader) {
}
