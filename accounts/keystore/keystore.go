...
// See https://github.com/420integrated/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // If the event notification loop is running
...
// HasAddress reports if a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Highcoin presale wallet and stores
