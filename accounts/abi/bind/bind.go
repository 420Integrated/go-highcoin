...
// Package bind generates Highcoin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-highcoin Wiki page:
// https://github.com/420integrated/go-highcoin/wiki/Native-DApps:-Go-bindings-to-Highcoin-contracts
package bind
