...
// BalanceAt returns the marleys balance of a certain account in the blockchain.
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call highcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call highcoin.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query highcoin.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query highcoin.FilterQuery, ch chan<- types.Log) (highcoin.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (highcoin.Subscription, error) {
