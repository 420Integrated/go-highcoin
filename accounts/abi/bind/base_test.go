...
func (mc *mockCaller) CallContract(ctx context.Context, call highcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call highcoin.CallMsg) ([]byte, error) {
