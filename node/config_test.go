...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "highcoin.ipc", false, filepath.Join(os.TempDir(), "highcoin.ipc")},
		{"data", "highcoin.ipc", false, "data/highcoin.ipc"},
		{"data", "./highcoin.ipc", false, "./highcoin.ipc"},
		{"data", "/highcoin.ipc", false, "/highcoin.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "highcoin.ipc", true, `\\.\pipe\highcoin.ipc`},
		{"data", "highcoin.ipc", true, `\\.\pipe\highcoin.ipc`},
		{"data", `\\.\pipe\highcoin.ipc`, true, `\\.\pipe\highcoin.ipc`},
	}
