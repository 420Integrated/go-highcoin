...
func (s *spongeDb) NewBatch() highdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) highdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w highdb.KeyValueWriter) error { return nil }
...
// to check if changes to the trie modifies the write order or data in any way.
