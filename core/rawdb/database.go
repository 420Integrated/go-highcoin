...
func NewDatabase(db highdb.KeyValueStore) highdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db highdb.KeyValueStore, freezer string, namespace string) (highdb.Database, error) {
...
func NewMemoryDatabase() highdb.Database {
...
func NewMemoryDatabaseWithCap(size int) highdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (highdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (highdb.Database, error) {
...
func InspectDatabase(db highdb.Database, keyPrefix, keyStart []byte) error {
