...
//   reserving it for go-highcoin. This would also reduce the memory requirements
//   of Highcoin, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db highdb.KeyValueStore) {
