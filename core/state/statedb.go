...
// Package state provides a caching layer atop the Highcoin state trie.
package state
...
// StateDB structs within the highcoin protocol are used to store anything
...
// Empty returns if the state object is either non-existent
...
//
// Carrying over the balance ensures that Highcoin doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/420integrated/go-highcoin/pull/16485#issuecomment-380438527),
