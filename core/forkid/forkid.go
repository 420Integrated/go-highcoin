...
// NewID calculates the Highcoin fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Highcoin fork ID from an existing chain instance.
