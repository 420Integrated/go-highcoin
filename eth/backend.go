...
// Package eth implements the Highcoin protocol.
package eth
...
import (
	...
	"github.com/420integrated/go-highcoin/eth/protocols/snap"
...
func (s *Highcoin) ChainDb() ethdb.Database            { return s.chainDb }
