...
func makeHeaderChain(parent *types.Header, n int, db highdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (highdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() highdb.Database {
	return odr.db
}
