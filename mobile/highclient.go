...
// Contains a wrapper for the Highcoin client.
...
// HighcoinClient provides access to the Highcoin APIs.
type HighcoinClient struct {
	client *highclient.Client
}

// NewHighcoinClient connects a client to the given URL.
func NewHighcoinClient(rawurl string) (client *HighcoinClient, _ error) {
	rawClient, err := highclient.Dial(rawurl)
	return &HighcoinClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *HighcoinClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *HighcoinClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *HighcoinClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *HighcoinClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *HighcoinClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *HighcoinClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *HighcoinClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *HighcoinClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *HighcoinClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
// GetBalanceAt returns the marleys balance of the given account.
// The block number can be <0, in which case the balance is taken from the latest known block.
func (ec *HighcoinClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *HighcoinClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
// GetPendingBalanceAt returns the marleys balance of the given account in the pending state.
func (ec *HighcoinClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *HighcoinClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *HighcoinClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *HighcoinClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *HighcoinClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *HighcoinClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *HighcoinClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
...
func (ec *HighcoinClient) SuggestSmokePrice(ctx *Context) (price *BigInt, _ error) {
	rawPrice, err := ec.client.SuggestSmokePrice(ctx.context)
	return &BigInt{rawPrice}, err
}

// EstimateSmoke tries to estimate the smoke needed to execute a specific transaction based on
// the current pending state of the backend blockchain. There is no guarantee that this is
// the true smoke limit requirement as other transactions may be added or removed by miners,
// but it should provide a basis for setting a reasonable default.
func (ec *HighcoinClient) EstimateSmoke(ctx *Context, msg *CallMsg) (smoke int64, _ error) {
...
func (ec *HighcoinClient) SendTransaction(ctx *Context, tx *Transaction) error {
