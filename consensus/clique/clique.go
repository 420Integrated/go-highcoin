...
// ecrecover extracts the Highcoin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Highcoin address
...
// Highcoin testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     highdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Highcoin address of the signing key
...
func New(config *params.CliqueConfig, db highdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Highcoin address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks if a header conforms to the consensus rules.
...
// verifyHeader checks if a header conforms to the consensus rules.The
...
// verifySeal checks if the signature contained in the header satisfies the
