...
// mapped from textual names used in the tests below to actual Highcoin private
...
// address retrieves the Highcoin address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Highcoin address
