...
// Package consensus implements different Highcoin consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Highcoin address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks if a header conforms to the consensus rules of a
